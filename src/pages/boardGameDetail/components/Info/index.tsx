  ...
  return (
    <>
      <img
        ...
        className='max-h-[240px] min-w-[350px] max-w-[450px] object-cover'
      />
      <div className='flex flex-col items-center gap-3 border-b border-gray-accent7 py-5'>
        ...
        <div className='flex flex-col items-center gap-1'>
          <Ripple className='flex h-8 w-8 items-center justify-center rounded-full border border-gray-accent3 '>
